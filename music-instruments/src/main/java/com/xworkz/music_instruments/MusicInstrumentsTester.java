...
import com.xworkz.music_instruments.config.MusicConfig;
...
public class MusicInstrumentsTester {
	...
	public static void main(String[] args) {
		...
		//MusicInstrumentsService mService = (MusicInstrumentsService) applicationContext.getBean("serviceMusicInstruments");
