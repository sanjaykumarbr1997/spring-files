package com.xworkz.music_instruments.config;
...
@ComponentScan({ "com.xworkz.music_instruments.config" })
@PropertySource(value = { "application.properties" })
public class MusicHibernateConfig {
	...
	public LocalSessionFactoryBean sessionFactory()
	{
		...
		sessionFactory.setPackagesToScan(
				new String[] { "com.xworkz.music_instruments.dto" });
	...
	private Properties hibernateProperties()
	{
		...
		properties.put("hibernate.id.new_generator_mappings", environment
				.getRequiredProperty("hibernate.id.new_generator_mappings"));
		return properties;
	}
